import{d as m,g as _,m as a,w as n,ab as i,aE as u,f}from"./index-ByXFUOik.js";import{E as g}from"./el-button-kBvbqf4l.js";import{E}from"./el-card-DeJihRRt.js";import{E as w}from"./index-D1SzvGqD.js";import{_ as y}from"./_plugin-vue_export-helper-DlAUqK2U.js";import"./use-form-common-props-DaVZpDU-.js";import"./directive-r3sbbdnM.js";const x={lock:!0,text:"加载中..."},p=(o,e={})=>{let r;return async(...c)=>{try{return r=w.service({...x,...e}),await o(...c)}finally{r.close()}}},C={code:0,data:{list:[]},message:"获取成功"};function S(o){return new Promise(e=>{setTimeout(()=>{e({...C,data:{list:o}})},1e3)})}function v(){return new Promise((o,e)=>{setTimeout(()=>{e(new Error("发生错误"))},1e3)})}const k={class:"app-container"},A=`
  <path class="path" d="
    M 30 15
    L 28 17
    M 25.61 25.61
