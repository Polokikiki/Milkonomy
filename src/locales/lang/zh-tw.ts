export default {
  ...
  "基准=该专业当前等级下利润最高的N个项目（N=基准项目数）；提升量=换装后在N个项目上的平均提升；护符只算经验。建议装备后的 +N 为强化等级，成本为该强化等级的市场买价。": "基準=該專業當前等級下利潤最高的N個項目（N=基準項目數）；提升量=換裝後在N個項目上的平均提升；護符只算經驗。建議裝備後的 +N 為強化等級，成本為該強化等級的市場買價。",
  "性价比 = 平均每小时提升 ÷ 购买成本。数值越大，每 1 金币买到的提升越多。例：换装后每小时多赚 1,000 金币、装备花 100,000 → 性价比 = 1,000 ÷ 100,000 = 0.01": "性價比 = 平均每小時提升 ÷ 購買成本。數值越大，每 1 金幣買到的提升越多。例：換裝後每小時多賺 1,000 金幣、裝備花 100,000 → 性價比 = 1,000 ÷ 100,000 = 0.01",
  "全部等级": "全部等級",
  "仅0级": "僅0級",
  "基准项目数": "基準項目數",
  "项均值": "項均值",
