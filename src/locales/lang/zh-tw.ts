export default {
  ...
  "买价：去市场买这件来源物品要花的钱。带「自制」标签 = 市场没人卖，按自己做出来的材料成本估算。": "買價：去市場買這件來源物品要花的錢。帶「自製」標籤 = 市場沒人賣，按自己做出來的材料成本估算。",
  ...
  "基准=该专业当前等级下利润最高的N个项目（N=基准项目数）；提升量=换装后在N个项目上的平均提升；护符只算经验。建议装备后的 +N 为强化等级，成本为该强化等级的市场买价。性价比列=每10万金币的提升量。": "基準=該專業當前等級下利潤最高的N個項目（N=基準項目數）；提升量=換裝後在N個項目上的平均提升；護符只算經驗。建議裝備後的 +N 為強化等級，成本為該強化等級的市場買價。性價比列=每10萬金幣的提升量。",
  "性价比 = 平均每小时提升 ÷ 购买成本 × 100,000，即每花 10 万金币能买到的每小时提升量。数值越大越划算。例：换装后每小时多赚 500 金币、装备花 100 万 → 性价比 = 50，即每 10 万金币换每小时 +50。": "性價比 = 平均每小時提升 ÷ 購買成本 × 100,000，即每花 10 萬金幣能買到的每小時提升量。數值越大越划算。例：換裝後每小時多賺 500 金幣、裝備花 100 萬 → 性價比 = 50，即每 10 萬金幣換每小時 +50。",
  "全部等级": "全部等級",
  "仅0级": "僅0級",
  "基准项目数": "基準項目數",
  "项均值": "項均值",
