...
async function onClipboardImport() {
 ...
 if (!text || !text.trim()) { ElMessageBox.alert('<p>检测到未安装数据导出脚本。</p><p style="margin-top:8px">📥 <a href="https://home.greasyfork.org.cn/zh-hans/info#/zh-CN/scripts/587094/detail" target="_blank">安装脚本</a></p><p style="margin-top:8px;color:#909399">安装后刷新 MilkyWay Idle 页面，再回利润网点「一键导入」。</p>', t("未安装脚本"), { dangerouslyUseHTMLString: true, confirmButtonText: t("知道了") }); return }
