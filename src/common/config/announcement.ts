...
export const announcementConfig: AnnouncementConfig = {
  enabled: true,
  id: "v2.7.0-gear-optimizer",
  message: {
    title: "v2.7.0 更新公告",
    content: [
      "一、新增「装备优化」页（本次主推）",
      "1. 选定你的预设，一键扫描全市场：按专业×部位（工具/衣服/裤子/披风/护符/特殊装备）逐件比较所有可买装备及各强化等级，按性价比推荐最划算的升级。",
      "2. 每条建议给出购买成本、平均利润提升、回本天数；护符按经验口径；基准为该专业利润最高的前 N 个项目均值（可调）。",
      "",
      "二、报价税率修复（重要）",
